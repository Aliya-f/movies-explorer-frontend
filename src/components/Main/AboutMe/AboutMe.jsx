        ...
        <div className="about-me__info">
          <div className="about-me__text">
            ...
            <ul className="about-me__link">
              <li><a href="https://github.com/Aliya-f">Github</a></li>
            </ul>
          </div>
          <img src={`https://foni.club/uploads/posts/2023-02/1677284635_foni-club-p-art-pop-muzhchina-43.jpg`} alt="фото" className="about-me__avatar"/>
        </div>
      </div>
      </section>
  );
